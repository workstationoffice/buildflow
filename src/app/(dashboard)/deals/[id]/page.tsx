...
import { AlertCircle, Calendar, MapPin, Paperclip, MessageSquare } from "lucide-react";
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border p-5 space-y-3">
            ...
            {[
              ...
              { label: "Site Location", value: deal.siteLocation ?? "—" },
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white rounded-xl border">
            <div className="px-5 py-4 border-b flex items-center justify-between">
              ...
              <Link href={`/deals/${id}/activity/new`} className="text-xs text-blue-600 hover:underline">+ Add</Link>
            </div>
